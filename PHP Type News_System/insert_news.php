<?php
    ...
    $newstype_detail = $_POST['newstype_detail'];
    ...
    $success = move_uploaded_file($_FILES['news_filename']['tmp_name'],$image_upload_path);
        ...
        $sql = "INSERT INTO tblogin (news_topic, newstype_detail, news_filename, news_status, news_data, newstype_id) 
            VALUES ('$news_topic',  '$newstype_detail',  $new_image_name ,  '$news_status, NOW(), '$newstype_id')";
